...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $content = $name . ' отправил запрос. Его почтовый ящик: ' . $email . '. Номер телефона: ' . $phone . '. ' . 'Область интересов: '. $areaOfInterest . '. Компания/организация: ' . $company . '.';
    ...
    $success = mail("artes30@mail.ru", 'Запрос с сайта Belinsoft', $content, $headers);
